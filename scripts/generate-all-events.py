...
HRR_2026_EVENTS: list[EventMeta] = [
    ...
    EventMeta("bridge", "THE BRIDGE CHALLENGE PLATE", "THE BRIDGE CHALLENGE PLATE", "Bridge Challenge Plate", "Bridge", "the-bridge-challenge-plate", ["Bridge"], "Intermediate men's eights", "intermediate-mens-eights", "pow", "bye"),
    ...
    EventMeta("wargrave", "THE WARGRA VE CHALLENGE CUP", "THE W ARGRAVE CHALLENGE CUP", "Wargrave Challenge Cup", "Wargrave", "the-wargrave-challenge-cup", ["Wargrave"], "Club men's coxless fours", "club-mens-coxless-fours", "pe", "standard", "wargrave"),
    ...
    EventMeta("town", "THE TOWN CHALLENGE CUP", "THE TOWN CHALLENGE CUP", "Town Challenge Cup", "Town", "the-town-challenge-cup", ["Town"], "Student men's coxless fours", "student-mens-coxless-fours", "pow", "bye"),
    ...
    EventMeta("queen-mother", "THE QUEEN MOTHER CHALLENGE CUP", "THE QUEEN MOTHER CHALLENGE CUP", "Queen Mother Challenge Cup", "Q Mother", "the-queen-mother-challenge-cup", ["Q Mother"], "Senior women's coxless fours", "senior-womens-coxless-fours", "pow", "bye"),
    EventMeta("princess-grace", "THE PRINCESS GRACE CHALLENGE CUP", "THE PRINCESS GRACE CHALLENGE CUP", "Princess Grace Challenge Cup", "P Grace", "the-princess-grace-challenge-cup", ["P Grace"], "Senior women's quadruple sculls", "senior-womens-quads", "pow", "final_only"),
    EventMeta("pow", "THE PRINCE OF WALES CHALLENGE CUP", "THE PRINCE OF W ALES CHALLENGE CUP", "Prince of Wales Challenge Cup", "POW", "the-prince-of-wales-challenge-cup", ["Pr Wales"], "Intermediate quads", "intermediate-quads", "pow", "skip"),
    EventMeta("princess-of-wales", "THE PRINCESS OF WALES CHALLENGE TROPHY", "THE PRINCESS OF W ALES CHALLENGE TROPHY", "Princess of Wales Challenge Trophy", "P Wales", "the-princess-of-wales-challenge-trophy", ["P Wales"], "Intermediate women's quads", "intermediate-womens-quads", "pow"),
    EventMeta("danesfield", "THE DANESFIELD CHALLENGE CUP", "THE DANESFIELD CHALLENGE CUP", "Danesfield Challenge Cup", "Danesfield", "the-danesfield-challenge-cup", ["Danesfield"], "Intermediate men's quads", "intermediate-mens-quads", "pow", "standard", "danesfield"),
    EventMeta("queen-victoria", "THE QUEEN VICTORIA CHALLENGE CUP", "THE QUEEN VICTORIA CHALLENGE CUP", "Queen Victoria Challenge Cup", "Q Victoria", "the-queen-victoria-challenge-cup", ["Q Victoria"], "Intermediate women's quads", "intermediate-womens-quads", "pow", "bye"),
    ...
    EventMeta("britannia", "THE BRITANNIA CHALLENGE CUP", "THE BRITANNIA CHALLENGE CUP", "Britannia Challenge Cup", "Britannia", "the-britannia-challenge-cup", ["Britannia"], "Club women's eights", "club-womens-eights", "pe", "standard", "britannia"),
