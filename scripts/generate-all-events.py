...
JRN_PREQUAL_SEEDS: dict[str, list[int]] = {
    ...
    "temple": [
        117, 119, 127, 130, 136, 144, 162, 184, 189, 195, 199, 201,
    ],
    ...
    "queen-victoria": [512, 514, 526, 531],
    "fawley": [
...
HRR_2026_EVENTS: list[EventMeta] = [
    ...
    EventMeta("double-sculls", "THE DOUBLE SCULLS CHALLENGE CUP", "THE DOUBLE SCULLS CHALLENGE CUP", "Double Sculls Challenge Cup", "Doubles", "the-double-sculls-challenge-cup", ["D Sculls"], "Premier men's double sculls", "premier-mens-doubles", "goblets"),
