...
HRR_2026_EVENTS: list[EventMeta] = [
    ...
    EventMeta("island", "THE ISLAND CHALLENGE CUP", "THE ISLAND CHALLENGE CUP", "Island Challenge Cup", "Island", "the-island-challenge-cup", ["Island"], "Women's eights", "womens-eights", "pe"),
